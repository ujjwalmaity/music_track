class TrendingMusic {
  ...
  TrendingMusic({this.message});

  TrendingMusic.fromJson(Map<String, dynamic> json) {
...
class Track {
  ...
  Track.fromJson(Map<String, dynamic> json) {
    ...
    primaryGenres = json['primary_genres'] != null ? new PrimaryGenres.fromJson(json['primary_genres']) : null;
  }
...
class PrimaryGenres {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.musicGenreList != null) {
      data['music_genre_list'] = this.musicGenreList.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class MusicGenreList {
  ...
  MusicGenreList.fromJson(Map<String, dynamic> json) {
    musicGenre = json['music_genre'] != null ? new MusicGenre.fromJson(json['music_genre']) : null;
  }
